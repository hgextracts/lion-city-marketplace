...
export const ListingDatum = Data.Object({
  seller: Address,
  pricePolicy: Data.Bytes(),
  priceName: Data.Bytes(),
  priceAmount: Data.Integer(),
  nftPolicy: Data.Bytes(),
  nftName: Data.Bytes(),
});

export type ListingDatum = typeof ListingDatum;

export const TokenFee = Data.Object({
  policy: Data.Bytes(), // 28-byte PolicyId
  name: Data.Bytes(), // Asset name in bytes (can be empty for ADA)
  fee_bps: Data.Integer(), // Fee in basis points
});
export type TokenFee = typeof TokenFee;

export const ConfigDatum = Data.Object({
  fee_address: Address, // Reuse existing Address type
  token_fees: Data.Array(TokenFee), // Array of allowed token fee rules
});
export type ConfigDatum = typeof ConfigDatum;
